...
public class AINExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(AINDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new AINStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static AINDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static AINDateTimeConverter dateTimeConverter = new AINStandardDateTimeConverter();

    public AINExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public AINExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new AINMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=AINHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,AINExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=AINHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
