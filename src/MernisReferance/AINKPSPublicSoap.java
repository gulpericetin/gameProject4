...
public class AINKPSPublicSoap
{
    ...
    public AINKPSPublicSoap(){}

    public AINKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public AINKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        AINExtendedSoapSerializationEnvelope envelope= new AINExtendedSoapSerializationEnvelope(AINExtendedSoapSerializationEnvelope.VER11);
